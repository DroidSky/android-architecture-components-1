...
class PublishingHousesListFragment : BaseFragment<FragmentMainPublishingHousesListBinding, PublishingHousesListViewModel>(), PublishingHousesListNavigator,
  ...
  override fun onDeleteClick(publishingHouseId: Long) {
    this.publishingHousesListViewModel.deletePublishingHouse(publishingHouseId)
  }

  override fun onRetryClick() {
    this.publishingHousesListViewModel.loadPublishingHouses()
  }
  ...
  private fun setUp() {
    ...
    this.swipeRefresh.setOnRefreshListener { this.publishingHousesListViewModel.loadPublishingHouses() }
  }

  private fun subscribeToLiveData() {
    publishingHousesListViewModel.getPublishingHousesListLiveData().observe(this, Observer { publishingHouses ->
      publishingHouses?.let { publishingHousesListViewModel.addPublishingHousesToList(it) }
    })
  }
}
